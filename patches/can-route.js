/**
 * Replace `node_modules/can-route/can-route.js:208`
 * 
...
var timer;
function canRoute_matchedRoute() {
...
var currentRuleObservable = new Observation(canRoute_matchedRoute);
...
canReflect.assignMap(canRoute, {
	...
	start: function (val) {
		...
		if (val !== true) {
			canRoute._setup();
	        // Patch START
			if (true || isBrowserWindow() || isWebWorker()) {
	        // Patch END
