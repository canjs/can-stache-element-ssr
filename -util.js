...
// 	return getWindow().NodeFilter.FILTER_ACCEPT;
// }
...
function getNodesWithTreeWalker(rootNode) {
	...
	// const actualWindow = getWindow();
	// const jsdomWindow = JSDOM_WINDOW;
	// const actualGlobal =  (function () { return this })();

	// console.log('actualWindow === jsdomWindow', actualWindow === jsdomWindow);
	// console.log('actualGlobal === jsdomWindow', actualGlobal === jsdomWindow);
	// console.log('actualWindow === actualGlobal', actualWindow === actualGlobal);

	// const doc = getDocument();

	// IE11 throws if createTreeWalker is called on a non-ElementNode
	var walker = isElementNode(rootNode) && doc.createTreeWalker(
		rootNode,
